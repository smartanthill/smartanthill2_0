...
#if !defined __HAL_PLATFORM_DESKTOP_TIME_CONVERTIONS_H__
#define __HAL_PLATFORM_DESKTOP_TIME_CONVERTIONS_H__
...
#endif // __HAL_PLATFORM_DESKTOP_TIME_CONVERTIONS_H__
